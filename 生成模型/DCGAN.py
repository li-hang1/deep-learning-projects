...
path = "C:/python/pythonProject/deep_learning/CIFAR10_npy/train/2"
a = np.load(os.path.join(path, "830.npy"))
plt.imshow(a)
plt.show()
...
# image = image.float() / 255.0 这里把像素变成0到1，然后这里再减均值除以方差，所以变成了[-1, 1]
